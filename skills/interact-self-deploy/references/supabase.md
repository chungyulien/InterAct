...
2. From the InterAct repository root, run `pnpm dlx supabase login --agent no --output-format text` and complete browser authentication. The explicit mode flags keep the prompt interactive when PowerShell was opened by Codex.
3. Run:
